...
public class WebClientV2IT {
    ...
    void testDeleteBeer() {
        ...
        webClient.delete().uri(BeerRouterConfig.BEER_V2_URL_SAVE + "/" + beerId )
                .retrieve().toBodilessEntity()
                .flatMap(responseEntity -> {
                    countDownLatch.countDown();

                    return webClient.get().uri(BeerRouterConfig.BEER_V2_URL_SAVE + "/" + beerId)
    ...
    void testUpdateBeerNotFound() throws InterruptedException {
        ...
        webClient.put().uri(BeerRouterConfig.BEER_V2_URL_SAVE + "/" + beerId)
    ...
    void testUpdateBeer() throws InterruptedException {
        ...
        webClient.get().uri(BeerRouterConfig.BEER_V2_URL_SAVE + "/" + beerId)
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class)
                .subscribe(beer -> {
    ...
    void testSaveBeer() throws InterruptedException {
        ...
        Mono<ResponseEntity<Void>> beerResponseMono = webClient.post().uri(BeerRouterConfig.BEER_V2_URL_SAVE)
    ...
    void getBeerByUPCNotFound() throws InterruptedException {
        ...
        Mono<BeerDto> beerDtoMono = webClient.get().uri(BeerRouterConfig.BEER_V2_URL_UPC + "/45647789895623")
                .accept(MediaType.APPLICATION_JSON)
                .retrieve().bodyToMono(BeerDto.class);
